...
<a href="{{ route('barangkeluar.export') }}" class="btn btn-success">
        <i class="bx bx-export"></i> Export Excel
    </a>

<a href="{{ route('barangkeluar.pdf') }}" class="btn btn-danger">
                ...
                <td>
                    <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                              <a href="{{ route('barangkeluar.edit', $a->id) }}" class="dropdown-item text-warning">
                                <i class="bx bx-edit-alt me-1"></i> Edit
                              </a>
                              <a href="{{ route('barangkeluar.show', $a->id) }}" class="dropdown-item text-dark">
                                <i class="bx bx-show-alt me-1"></i> Show
                              </a>
                              <form action="{{ route('barangkeluar.destroy', $a->id) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus barang ini?')">
                                @csrf
                                @method('DELETE')
